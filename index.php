  ...
  <div class="page-wrapper with-sidebar" data-sidebar-type="overlayed-all">
    ...
    <div class="content-wrapper">
      ...
      <div class="mainSlider" id="mainSlider" style="background-image: url('background.png');">
        ...
        <h1 class="sliderBaslik1">İkinci El Araç
          Havuzu</h1>

          <p class="sliderDesc1">ARAÇ ALIM-SATIMININ
            EN HIZLI YOLU!</p>

            <hr>

            <p class="aciklama sliderDesc1">
              Geniş araç seçeneklerimizle; istediğiniz aracı güvenle satın alabilir, aracınızı değerinde anında satabilirsiniz veya araç kiralayabilirsiniz.
            </p>
            ...
            <div class="container-fluid">
              ...
              <div class="row" style="color:white" id="araclarimiz">
                <h2>Araçlarımız</h2>
              </div>
            ...
            $sayac = 0;
              ...
              if ($resultsproje->num_rows > 0) {
                  while($row = $resultsproje->fetch_assoc()) {
                    ...
                    echo '
                    <div class="col-xl-2 card p-0 aracdiv" id="arac'.$row["id"].'">
                        <span class="yearofcar">'.$row["aracModelYili"].'</span> 
                  
                        
                        <img style="width: 100%;" src="'.$row["aracGorseli1"].'" alt="" class="fotograf">
      
                                 <div class="priceofcar">'.$row["ilanFiyat"].'₺</div>
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><i class="fa-solid fa-gauge"></i> '.$row["aracMotorHacmi"].'cc</td>
                                <td><i class="fa-solid fa-gear"></i> '.$row["aracVites"].'</td>
                                <td><i class="fa-solid fa-gas-pump"></i> '.$row["aracYakit"].'</td>
              ...
              <div class="row">
                ...
                <h4 class="genelBaslik">Developed by <a href="https://www.linkedin.com/in/furkan-berkehan/" style="color:#006869">Fuber</a></h4>
              </div>
            </div>
      </div>
...
const divs = document.querySelectorAll('.aracdiv');

// Div'lere tıklama olayı ekliyoruz
for (let i = 0; i < divs.length; i++) {
  divs[i].addEventListener('click', function() {
    const idNum = divs[i].id.replace('arac', '');
    window.location.href = "aracincele.php?id=" + idNum;
  });
}
