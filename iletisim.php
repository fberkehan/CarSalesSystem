  ...
  <div class="page-wrapper with-sidebar" data-sidebar-type="overlayed-all">
    ...
    <div class="content-wrapper">
      ...
      <div class="mainSlider" id="mainSlider" style="background-image: url('background.png');">
        ...
        <div class="row" style="background-color: #132727;
    border-radius: 30px;
    padding: 5vw;
    ...
    margin-top:2vw !important;">
                     ...
                     <form action="..." method="...">
                     <h2 class="content-title" style="font-size:30px;"> İletişime Geçin
          </h2>
          ...
          <input class="btn btn-primary btn-block" type="submit" value="Talep Gönder">
                            ...
                            <div class="col-sm-6"><div class="content">
                        <h2 class="content-title">
                            İletişim Sayfası
                            <a href="#inline-forms-with-form-groups" class="ml-5 text-decoration-none">#</a>
                        </h2>
                        <p style=" font-family: 'Questrial', sans-serif;">
                        <h4>İletişim Sayfamıza Hoş Geldiniz!</h4>

Bizimle iletişime geçmek istediğiniz için teşekkür ederiz. İletişim formumuzu kullanarak, telefon, adres veya mail adresimizi kullanarak bizimle iletişime geçebilirsiniz.

Bizimle iletişime geçmeden önce lütfen dikkat edin:

Mesajınızın ne olduğuna dair kısa bir açıklama ekleyin, böylece en doğru kişiye ulaştırabiliriz.
Mesajınızda kişisel bilgilerinizi paylaşmaktan kaçının. Lütfen sadece gerekli bilgileri girin, böylece sizi yanıtlayabiliriz.
Mesajınızın cevaplanması için lütfen birkaç iş günü sürebilir. Sabrınız için teşekkür ederiz.
Eğer acil bir sorunuz varsa, lütfen telefon numaramızı arayın.

Teşekkürler! </p>

<p style=" font-family: 'Questrial', sans-serif;"> 
              <span style="font-family: 'Questrial', sans-serif;font-weight: bold;color: cadetblue;">Telefon :</span> <?php echo $firmaTelefon; ?> <br/>
              <span style="font-family: 'Questrial', sans-serif;font-weight: bold;color: cadetblue;">Adres : </span> <?php echo $firmaAdres; ?> <br/>
              <span style="font-family: 'Questrial', sans-serif;font-weight: bold;color: cadetblue;">E-posta :  </span> <?php echo $firmaMail; ?> <br/>
            </p>
                    </div></div>
